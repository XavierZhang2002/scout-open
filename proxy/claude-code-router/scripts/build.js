...
try {
  ...
  // Build the main foreground application
  console.log('Building main foreground application...');
  execSync('esbuild src/main.ts --bundle --platform=node --outfile=dist/main.js', { stdio: 'inherit' });
